...
.auth-pokeball .pokeball-top { position: absolute; top: 0; left: 0; right: 0; height: 50%; background: var(--accent-primary); }
.auth-pokeball .pokeball-line { position: absolute; top: 50%; left: 0; right: 0; height: 4px; background: #444; transform: translateY(-50%); z-index: 2; }
.auth-pokeball .pokeball-center { position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 18px; height: 18px; border-radius: 50%; background: white; border: 3px solid #444; z-index: 3; }
.auth-header h1 {
  font-size: 28px;
  font-weight: 800;
